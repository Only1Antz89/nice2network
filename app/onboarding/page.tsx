...
type ProfileDraft={username:string;profession:string;industry:string;bio:string;primarySkill:string;secondarySkill:string;tertiarySkill:string;interests:string;location:string;workMode:"remote"|"hybrid"|"in_person"};
...
const initialDraft:ProfileDraft={username:"",profession:"",industry:"",bio:"",primarySkill:"",secondarySkill:"",tertiarySkill:"",interests:"",location:"",workMode:"hybrid"};
...
export default function OnboardingPage(){
  ...
  useEffect(()=>{fetch("/api/auth/onboarding",{cache:"no-store"}).then(response=>response.ok?response.json():null).then(result=>{if(result?.username)setDraft(current=>({...current,username:result.username}))}).catch(()=>undefined)},[]);
