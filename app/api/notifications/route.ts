...
export async function GET() {
  try {
    ...
    return NextResponse.json({ notifications: items, unread: unread.value, preferences: preferences ?? { messages: true, projects: true, matches: true, meets: true, officialNotices: true, followedUpdates: true, emailDigest: "weekly" } });
