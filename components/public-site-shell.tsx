  ...
  return (
    <div className={`public-site public-site--${tone}`}>
      <header className="public-header">
        ...
        <Link className="public-join" href="/signin?mode=register">Join the network <span aria-hidden="true">↗</span></Link>
      </header>
      {children}
      <footer className="public-footer">
        ...
        <div className="public-credit"><small>© 2026 nice 2 network</small><small>Built by <strong>IntAillium</strong></small></div>
      </footer>
    </div>
  );
}
